...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hai ${pushname} Gunakanlah Bot Sebaik Mungkin\n\nMaaf Kak ${pushname} Jangan Dispam Ye Botnya☝️😅\n`,
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "[ 🔄 ]Random Menu",
										"description": "Menampilkan Random Menu ⛓️",
									...
									{
										"title": "[ 💫 ]Voice Changer",
										"description": "Menampilkan Menu VC 🎙️",
